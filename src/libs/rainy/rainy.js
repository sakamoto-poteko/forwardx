 ...
 */
export default function RainyDay(a) {
    if (this === window) return new RainyDay(a);
    var b = "string" == typeof a.image ? document.getElementById(a.image) : a.image;
    if ("img" === b.tagName.toLowerCase()) this.imgSource = null, this.img = b, this.initialize(a); else {
        var c = this, d = b.currentStyle || window.getComputedStyle(b, !1),
            e = d.backgroundImage.slice(4, -1).replace(/"/g, ""), f = document.createElement("img");
        f.onload = function () {
...
RainyDay.prototype.destroy = function () {
    ...
    var b = this.imgSource || a.parentElement || document.getElementsByTagName("body")[0], c = window.getOffset(b);
    ...
    this.options = a, this.drops = [], this.canvas = this.options.canvas || this.prepareCanvas(), this.prepareBackground(), this.prepareGlass(), this.reflection = this.REFLECTION_MINIATURE, this.trail = this.TRAIL_DROPS, this.gravity = this.GRAVITY_NON_LINEAR, this.collision = this.COLLISION_SIMPLE, this.setRequestAnimFrame(), this.rain([[3, 5, .5]], 50)
    ...
    var a = this.options.parentElement.getBoundingClientRect(), b = a.width, c = a.bottom - a.top, d = b, e = c,
        f = a.left, g = a.top, h = this.canvas.width, i = this.canvas.height, j = this.canvas.offsetLeft,
    ...
    this.addDropCallback = function () {
        ...
        if (!(c - g < b)) {
            ...
            for (var e, f = 0; f < a.length; f++) if (a[f][2] > 1 || a[f][3] === -1) {
                if (0 !== a[f][3]) {
                    a[f][3]--;
    ...
    var a = this.r;
    if (this.r = Math.floor(.95 * this.r), this.r < 3) this.context.arc(this.x, this.y, this.r, 0, 2 * Math.PI, !0), this.context.closePath(); else if (this.colliding || this.yspeed > 2) {
        if (this.colliding) {
    ...
    var b = a.y - a.r - 3, c = a.x - Math.floor(a.r / 2) + 2 * Math.random();
    ...
    for (var c, d = b; null != d;) {
        var e = d.drop, f = a.r + e.r, g = a.x - e.x, h = a.y - e.y;
    ...
    var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z = this.background.getContext("2d"),
        A = z.getImageData(0, 0, a, b), B = A.data, C = c + 1, D = C * (C + 1) / 2, E = new BlurStack,
        F = new BlurStack, G = E;
